...
const ServicesTable = ({ servicios, onVer, onEditar, onEliminar }) => {
  return (
      ...
      {servicios.map((servicio) => (
        ...
        >
          ...
          <div className="w-28 h-28 bg-gray-200 rounded-md mb-4 flex items-center justify-center">
            {servicio.imagen ? (
              <img src={servicio.imagen} alt={servicio.nombre} className="object-cover w-full h-full rounded-md" />
            ) : (
          ...
          <h3 className="text-base font-semibold text-gray-800">{servicio.nombre}</h3>
