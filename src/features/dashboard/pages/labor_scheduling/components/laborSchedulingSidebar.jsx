...
import { FaSearch, FaUser, FaEye, FaEyeSlash, FaPlus, FaCogs, FaCalendarAlt } from 'react-icons/fa';
      ...
      <div className="p-4 border-b border-yellow-100 bg-white/60 flex flex-col gap-2">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-conv3r-dark bg-conv3r-gold hover:brightness-95 transition-transform hover:scale-105 flex items-center justify-center gap-2"
          >
