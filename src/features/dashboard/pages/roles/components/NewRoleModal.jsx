...
const NewRoleModal = ({ isOpen, onClose, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Datos del rol a guardar:", roleData, formattedPermissions);

      // Llamar a la función onSave que viene del componente padre
      await onSave(roleData, formattedPermissions);
  ...
  console.log("✅ NewRoleModal: Modal is open, rendering");
              ...
              <div>
                ...
                >
                  ...
                  <span
                    ...
                    title="El nombre del rol debe ser único y representativo."
                  >
                    ⓘ
                  </span>
                </label>
                <input
                  ...
                  required
                  aria-invalid={!!roleName.trim()}
                  aria-describedby="error-nombreRol"
                />
                {roleName.trim() && !roleName.trim().length && (
                  <span
                    id="error-nombreRol"
